...
const Pictures = () => {
  let initialList = localStorage.getItem("myimglist")
    ? JSON.parse(localStorage.getItem("myimglist"))
    : [""];
  ...
  useEffect(() => {
    async function getList() {
      fetch("/api/img/getmyimglist/", {
        ...
        .then(data => {
          localStorage.setItem("myimglist", JSON.stringify(data.objectList));
