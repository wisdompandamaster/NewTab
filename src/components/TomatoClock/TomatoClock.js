...
import { memo, useEffect, useState, useRef, React } from "react";
  ...
  const SetTomatoClock = props => {
    ...
    return (
      ...
      >
        ...
        >
          <FormItem
            label={<div style={{ fontSize: "1.2rem" }}>任务名</div>}
            name='name'
            rules={[
              {
                required: true,
          ...
          <FormItem
            label={<div style={{ fontSize: "1.2rem" }}>番茄钟数</div>}
            name='round'
            initialValue={3}
          >
        ...
        >
          <div style={{ marginBottom: "20%" }}>
            {"专注时间 "}
            <InputNumber
              style={{ background: "#0002", marginLeft: "10px" }}
              bordered={false}
  ...
  return (
    <FuncCard title='番茄时钟'>
      ...
      <div style={{ height: "100%", padding: "0 5%" }} onClick={showModal}>
        <div
          className='circle'
          style={{ height: "75%", border: "0px solid red", display: "flex" }}
        >
              ...
              if (percent < 100) {
                return (
                  <span style={{ fontWeight: "600" }}>
                    {String(Math.floor((count / 60) % 60)).padStart(2, "0") +
                      " : " +
          ...
          >
            <div
              style={{
                textDecoration: roundDone ? "line-through" : "none",
                color: roundDone ? "#00000066" : "",
              }}
            >
              {item.name}
            </div>
            ...
            <div>
              <Tag style={{ marginRight: "10px" }} color='#ff000055'>
                {currentRound} / {item.round}
              </Tag>
              <Tag
                color='green'
                style={{
                  display: isWork ? "none" : "inline-block",
                  marginRight: "0",
                }}
              >
                休息
              ...
              <Tag
                ...
                color='red'
                style={{
                  display: isWork ? "inline-block" : "none",
                  marginRight: "0",
                }}
              >
                学习
