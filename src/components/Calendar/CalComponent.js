            ...
            <Calendar
              ...
              tileContent={({ activeStartDate, date, view }) => {
                if (view == "month") {
                  ...
                  let lunar = (
                    <div style={{ color: "black" }}>{l.getDayInChinese()}</div>
                  ); //获取农历
                  let jq = l.getJieQi();
                  let n =
                    i_holidays.length === 0
                      ? ""
                      : i_holidays[0].replace("万圣节前夜", "万圣夜"); //切换农历和节日，替换(万圣节前夜 为 万圣夜 如果有的话)
                  ...
                  return (
                    ...
                    >
                      ...
                      {d ? (
                        d.isWork() ? (
                          <div className='is-work work'>班</div>
                        ) : (
                          <div className='is-work'>休</div>
                        )
                      ) : (
                        ""
                      )}
